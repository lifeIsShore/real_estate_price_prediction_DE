...
from airport_dist_score import calculate_airport_distance_log  # Modülden fonksiyonu dahil ediyoruz
...
OUTPUT_FILE = r"C:\Users\ahmty\Desktop\Python\real_estate_price_prediction_DE\real_estate_price_prediction_DE\csv_output\ad_id-address-airport_scored.csv"
...
def process_batch(batch_df):
    ...
    def safe_score(address):
        ...
        while attempt < MAX_RETRIES:
            try:
                return calculate_airport_distance_log(address) # only diff between addres scoring geo scored is that function, that entire script is compatible for all 3 func.
